...
<body>
	...
	<caption>Details for user: <?php echo $_POST['username'] ?></caption>
	  <thead>
	    <tr>
	      <th scope="col">#</th>
...
$result = mysqli_query($cser, "SELECT * FROM Crimson_Employee WHERE `CrimsonEmployeeUsername` = '".$_POST["username"]."' and `CrimsonEmployeePassword` = '".$_POST["password"]."' ");
